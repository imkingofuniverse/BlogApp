...
public class CommentServiceImpl implements CommentService {
	...
	public CommentDto createComment(long postId, CommentDto commentDto) throws PostNotFoundException {
		...
		Post post = postRepository.findById(postId)
				.orElseThrow(() -> new PostNotFoundException("Post not found for post ID: " + postId));
	...
	public CommentDto getCommentById(Long postId, Long commentId)
		...
		Comment comment = commentRepository.findById(commentId)
				.orElseThrow(() -> new CommentNotFoundException("Comment not found for comment ID: " + commentId));
